...
from TheLanguage1.Common.Errors import *  # type: ignore[import-untyped]
...
class TestError:
    ...
    def test_SingleLineSingleRegion(self):
        ...
        assert str(e) == "Single line, single region (foo, line 1, column 2 -> line 3, column 4)"
    ...
    def test_MultipleLinesSingleRegion(self):
        ...
        assert str(e) == textwrap.dedent(
            ...
            single region
                ...
                - foo, line 1, column 2 -> line 3, column 4
            """,
        )
    ...
    def test_SingleLineMultipleRegions(self):
        ...
        assert str(e) == textwrap.dedent(
            ...
            Single line, multiple regions
                ...
                - foo, line 1, column 2 -> line 3, column 4
                - bar, line 5, column 6 -> line 7, column 8
            """,
        )
